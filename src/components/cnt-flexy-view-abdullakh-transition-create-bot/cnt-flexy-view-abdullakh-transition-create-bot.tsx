...
@Component({
  tag: 'cnt-flexy-view-abdullakh-transition-create-bot',
  styleUrl: 'cnt-flexy-view-abdullakh-transition-create-bot.css',
  shadow: false,
})
export class CntFlexyViewAbdullakhCreateBot implements ComponentInterface {
  /**
