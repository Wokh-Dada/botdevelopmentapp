...
@Component({
  tag: 'cnt-flexy-view-abdullakh-bot-performance-information',
  styleUrl: 'cnt-flexy-view-abdullakh-bot-performance-information.css',
  shadow: false,
  scoped: true
})
export class CntFlexyViewAbdullakhBotPerformanceInformation implements ComponentInterface {
  /**
          ...
          <div class="PerformanceInformationContentBlock">
            <div class="PerformanceInformationContent wow animate__animated animate__backInUp">
              <div class="PerformanceInformationContentStart">
                <cnt-flexy-view-abdullakh-bot-performance-information-list PerformanceInformation={this.PerformanceInformation.right}
              ...
              <div class="PerformanceInformationContentEnd">
                ...
                <cnt-flexy-view-abdullakh-bot-performance-information-list PerformanceInformation={this.PerformanceInformation.left}
