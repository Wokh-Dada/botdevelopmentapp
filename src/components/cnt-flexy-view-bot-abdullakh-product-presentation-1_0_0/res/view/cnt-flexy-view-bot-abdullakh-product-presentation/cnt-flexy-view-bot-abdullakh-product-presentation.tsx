...
@Component({
  tag: 'cnt-flexy-view-bot-abdullakh-product-presentation',
  styleUrl: 'cnt-flexy-view-bot-abdullakh-product-presentation.css',
  shadow: false,
})
export class CntFlexyViewAbdullakhProductPresentation implements ComponentInterface {
  /**
