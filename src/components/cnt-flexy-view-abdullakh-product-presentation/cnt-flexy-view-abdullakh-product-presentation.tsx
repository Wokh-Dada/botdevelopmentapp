...
@Component({
  tag: 'cnt-flexy-view-abdullakh-product-presentation-1_0_0',
  styleUrl: 'cnt-flexy-view-abdullakh-product-presentation-1_0_0.css',
  shadow: false,
})
export class CntFlexyViewAbdullakhProductPresentation1_0_0 implements ComponentInterface {
  /**
